    ...
    <div class="flex max-w-7xl justify-around" style="margin:0 auto;">
        ...
        <div class="w-80"><!-- 右側 -->
            <div><!-- 名前 値段 -->
                ...
                <div class="pt-10">
                足の力を最大限に引き出すをコンセプトとして開発されたトレーニングシューズ。<br>
                アッパー素材にホールガーメントニットを使用し、立体的に編んでいるため、足にしっかりと密着。<br>
                インソールは足指本来の動きや足底筋膜の力を最大限に引き出す硬さに調整されたものであり、取り外しも可能。<br>
                <span class="text-red-500">足底筋膜を鍛えたい方、はだしの感覚を手に入れたい方向け！</span>
