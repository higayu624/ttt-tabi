...
<main class="pt-20 pb-20">
    <div class="flex max-w-7xl justify-around" style="margin:0 auto;">
        <div class="max-w-2xl"><!-- 左側 -->
            <div><!-- 写真 -->
                <div style="margin:0 auto"><img id="jogair-main" class="w-full" src="<?php echo get_template_directory_uri(); ?>/images/sportsair/1.jpg"></div>
                <div class="flex mt-5">
                    <div class="w-28 hover:scale-125" id="jogair-0"><img src="<?php echo get_template_directory_uri(); ?>/images/sportsair/1.jpg"></div>
                    <div class="w-28 hover:scale-125 ml-8" id="jogair-1"><img src="<?php echo get_template_directory_uri(); ?>/images/sportsair/2.jpg"></div>
                    <div class="w-28 hover:scale-125 ml-8" id="jogair-2"><img src="<?php echo get_template_directory_uri(); ?>/images/sportsair/3.jpg"></div>
                    <div class="w-28 hover:scale-125 ml-8" id="jogair-3"><img src="<?php echo get_template_directory_uri(); ?>/images/sportsair/4.jpg"></div>
                    <div class="w-28 hover:scale-125 ml-8" id="jogair-4"><img src="<?php echo get_template_directory_uri(); ?>/images/sportsair/5.jpg"></div>
                    <div class="w-28 hover:scale-125 ml-8" id="jogair-5"><img src="<?php echo get_template_directory_uri(); ?>/images/sportsair/6.jpg"></div>
                </div>
            </div>
            <div class="pt-20"><!-- 仕様 -->
        ...
        <div class="w-80"><!-- 右側 -->
            <div><!-- 名前 値段 -->
                <h1 class="font-bold text-2xl pt-10">スポーツジョグAIR</h1>
                <h3 class="font-black text-xl pt-20">¥6,930</h3>
                <p class="pt-5">カラー/ブラック 画像のサイズ/22.5</p>
                <div class="pt-10">
                ローカットタイプであるため足首を自由に動かすことのできるトレーニングシューズ。<br>
                クッションは衝撃をしっかりと吸収するエアークッションを採用。片足220ｇと超軽量型。<br>
                <span class="text-red-500">ジョギングや横の動きが多いハードなトレーニング向け</span>
