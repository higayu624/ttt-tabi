    ...
    <header class="border-b-2 sticky border-b top-0 bg-white">
        <div class="w-full h-20 flex max-w-5xl mx-auto justify-between">
            ...
            <ul class="flex items-center leading-10 px-2.5 py-3 overflow-hidden">
                ...
                <li id="tabi-button">
                    <a href="<?php echo home_url(); ?>/tabi" class="mr-2" id="tabi">TABI</a>
                    <div class="absolute hidden" id="tabis">
                        <a href="<?php echo home_url(); ?>/sportsjog"><p class="hover:bg-blue-100 text-center p-1 bg-white border border-gray-200">SPORTS JOG</p></a>
                        <a href="<?php echo home_url(); ?>/sportsjog-air"><p class="hover:bg-blue-100 text-center p-1 bg-white border border-gray-200">SPORTS JOG AIR</p></a>
                        <a href="<?php echo home_url(); ?>/sportsjog3"><p class="hover:bg-blue-100 text-center p-1 bg-white border border-gray-200">SPORTS JOG 3</p></a>
                        <a href="<?php echo home_url(); ?>/hitoe"><p class="hover:bg-blue-100 text-center p-1 bg-white border border-gray-200">hitoe</p></a>
                    </div>
                </li>
